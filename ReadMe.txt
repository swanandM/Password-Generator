Engineering Programming 2 Project

A password generator.         (PasswordGenerator.java)

Run PasswordGenerator.java file in any java code editor, GUI window will appear.
